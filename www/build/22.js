...
var ItemDetailsPageExpandable = /** @class */ (function () {
    ...
    ItemDetailsPageExpandable = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-expandable/item-details-expandable.html"*/'<!--Expandable components-->\n\n<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n        <ion-title text-left>{{params.title}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<!--Content-->\n\n\n\n<expandable-layout-1 *ngIf="params.expandableLayout1" [data]="params.data | async" [events]="params.events">\n\n</expandable-layout-1>\n\n\n\n<expandable-layout-2 *ngIf="params.expandableLayout2" [data]="params.data | async" [events]="params.events">\n\n</expandable-layout-2>\n\n\n\n<expandable-layout-3 *ngIf="params.expandableLayout3" [data]="params.data | async" [events]="params.events">\n\n</expandable-layout-3>'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-expandable/item-details-expandable.html"*/,
        }),
