...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__radio_button_layout_1__ = __webpack_require__(839);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__radio_button_layout_2__ = __webpack_require__(840);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__radio_button_layout_3__ = __webpack_require__(841);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_radio_button_layout_1_radio_button_layout_1_module__ = __webpack_require__(589);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_radio_button_layout_2_radio_button_layout_2_module__ = __webpack_require__(590);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_radio_button_layout_3_radio_button_layout_3_module__ = __webpack_require__(591);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RadioButtonLayout2 = (function () {
    ...
    RadioButtonLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'radio-button-layout-2',template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/radio-button/layout-2/radio-button.html"*/'<!--Themes Radio Button - With Avatars -->\n\n<ion-grid no-padding *ngIf="data != null">\n\n    <ion-list radio-group [(ngModel)]="data.selectedItem">\n\n        <!-- Header Title Top -->\n\n        <ion-list-header header-section>\n\n            <h1 header-title text-capitalize>{{data.title}}</h1>\n\n        </ion-list-header>\n\n        <!--Content -->\n\n        <ion-item *ngFor="let item of data.items; let i= index">\n\n            <!-- Content Avatar -->\n\n            <div gradient item-start>\n\n                <img images-filter [src]="item.avatar" />\n\n            </div>\n\n            <!-- Content Title -->\n\n            <ion-label item-title padding-top>{{item.title}}</ion-label>\n\n            <!-- Content Subtitle -->\n\n            <ion-label item-subtitle text-wrap>{{item.subtitle}}</ion-label>\n\n            <ion-radio item-end [value]="item.id" (ionSelect)="onEvent(\'onSelect\',item)" [checked]="item.isChecked"></ion-radio>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-grid>\n\n'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/radio-button/layout-2/radio-button.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], RadioButtonLayout2);
...
var RadioButtonLayout3 = (function () {
    ...
    RadioButtonLayout3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'radio-button-layout-3',template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/radio-button/layout-3/radio-button.html"*/'<!--Themes Radio Button - Simple 2-->\n\n<ion-grid no-padding *ngIf="data != null">\n\n    <ion-list radio-group [(ngModel)]="data.selectedItem">\n\n        <!-- Header Title Top -->\n\n        <ion-list-header header-section>\n\n            <h1 header-title text-capitalize>{{data.title}}</h1>\n\n        </ion-list-header>\n\n        <!--Content -->\n\n        <ion-item lines *ngFor="let item of data.items; let i= index">\n\n            <ion-radio item-start [value]="item.id" (ionSelect)="onEvent(\'onSelect\',item)"></ion-radio>\n\n            <!--Content Title-->\n\n            <ion-label item-title>{{item.title}}</ion-label>\n\n            <!--Content Subtitle-->\n\n            <ion-label item-end text-right item-subtitle>{{item.subtitle}}</ion-label>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-grid>\n\n'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/radio-button/layout-3/radio-button.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], RadioButtonLayout3);
...
var ItemDetailsPageRadioButton = (function () {
    ...
    ItemDetailsPageRadioButton = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-radio-button/item-details-radio-button.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n        <ion-title text-left>{{params.title}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<!--Content-->\n\n<ion-content>\n\n    <!--Radio Button - LAYOUT 1 component-->\n\n    <radio-button-layout-1 *ngIf="params.radioButtonLayout1" [data]="params.data | async" [events]="params.events">\n\n    </radio-button-layout-1>\n\n\n\n    <!--Radio Button - LAYOUT 2 component-->\n\n    <radio-button-layout-2 *ngIf="params.radioButtonLayout2" [data]="params.data | async" [events]="params.events">\n\n    </radio-button-layout-2>\n\n\n\n    <!--Radio Button - LAYOUT 3 component-->\n\n    <radio-button-layout-3 *ngIf="params.radioButtonLayout3" [data]="params.data | async" [events]="params.events">\n\n    </radio-button-layout-3>\n\n</ion-content>'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-radio-button/item-details-radio-button.html"*/
        }),
