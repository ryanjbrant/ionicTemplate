...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__drag_and_drop_layout_2__ = __webpack_require__(816);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_details_drag_and_drop__ = __webpack_require__(876);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_list_view_drag_and_drop_layout_2_drag_and_drop_layout_2_module__ = __webpack_require__(566);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_list_view_drag_and_drop_layout_3_drag_and_drop_layout_3_module__ = __webpack_require__(565);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DragAndDropLayout1 = (function () {
    ...
    DragAndDropLayout1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'drag-and-drop-layout-1',template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/list-view/drag-and-drop/layout-1/drag-and-drop.html"*/'<!-- Themes Drag and drop - Small item + header -->\n\n<ion-content has-header>\n\n    <ion-grid no-padding *ngIf="data != null">\n\n        <!--Header-->\n\n        <ion-row>\n\n            <!--Content-->\n\n            <ion-col col-12>\n\n                <ion-list-header header-section>\n\n                    <h1 header-title>{{data.header}}</h1>\n\n                </ion-list-header>\n\n                <ion-list reorder="true" (ionItemReorder)="reorderItems($event)">\n\n                    <ion-item border no-lines padding-left *ngFor="let item of data.items; let i = index;"\n\n                    (click)="onEvent(\'onItemClick\', item.title, $event)">\n\n                        <h2 item-title>{{item.title}}</h2>\n\n                        <h3 item-subtitle>{{item.subtitle}}</h3>\n\n                        <p item-subtitle item-end>{{item.textIcon}}</p>\n\n                    </ion-item>\n\n                </ion-list>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/list-view/drag-and-drop/layout-1/drag-and-drop.html"*/
        }),
...
var ItemDetailsPageDragAndDrop = (function () {
    ...
    ItemDetailsPageDragAndDrop = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-drag-and-drop/item-details-drag-and-drop.html"*/'<!--Dragen and drop components-->\n\n<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n        <ion-title text-left>{{params.title}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<!---Content-->\n\n\n\n<drag-and-drop-layout-1 *ngIf="params.dragAndDropLayout1" [data]="params.data | async" [events]="params.events">\n\n</drag-and-drop-layout-1>\n\n\n\n<drag-and-drop-layout-2 *ngIf="params.dragAndDropLayout2" [data]="params.data | async" [events]="params.events">\n\n</drag-and-drop-layout-2>\n\n\n\n<drag-and-drop-layout-3 *ngIf="params.dragAndDropLayout3" [data]="params.data | async" [events]="params.events">\n\n</drag-and-drop-layout-3>'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-drag-and-drop/item-details-drag-and-drop.html"*/
        }),
