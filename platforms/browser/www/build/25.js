...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__check_box_layout_1__ = __webpack_require__(805);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_check_box_layout_1_check_box_layout_1_module__ = __webpack_require__(555);
...
var CheckBoxLayout2 = (function () {
    ...
    CheckBoxLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'check-box-layout-2',template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/check-box/layout-2/check-box.html"*/'<!--Themes With avatar -->\n\n<ion-grid no-padding *ngIf="data != null">\n\n    <ion-row>\n\n        <ion-col col-12 no-padding>\n\n            <!-- Header Title Top -->\n\n            <ion-list-header header-section>\n\n                <h1 header-title text-capitalize>{{data.title}}</h1>\n\n            </ion-list-header>\n\n            <!-- Content List -->\n\n            <ion-list>\n\n                <ion-item border no-lines *ngFor="let item of data.items" (tap)="onEvent(\'onButton\', item)">\n\n                    <!-- Content  Avatar-->\n\n                    <div gradient item-start>\n\n                        <img images-filter [src]="item.image">\n\n                    </div>\n\n                    <!-- Content Title -->\n\n                    <ion-label padding-top item-title>{{item.title}}</ion-label>\n\n                    <!-- Content Subtitle -->\n\n                    <ion-label item-subtitle>{{item.subtitle}}</ion-label>\n\n                    <ion-checkbox item-end [checked]="item.isChecked"></ion-checkbox>\n\n                </ion-item>\n\n            </ion-list>\n\n        </ion-col>\n\n    </ion-row>\n\n</ion-grid>\n\n'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/check-box/layout-2/check-box.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], CheckBoxLayout2);
...
var CheckBoxLayout1 = (function () {
    ...
    CheckBoxLayout1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'check-box-layout-1',template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/check-box/layout-1/check-box.html"*/'<!--Themes Simple -->\n\n<ion-grid no-padding *ngIf="data != null">\n\n    <ion-row>\n\n        <ion-col col-12>\n\n            <!-- Header Title Top -->\n\n            <ion-list-header header-section>\n\n                <h1 header-title text-capitalize>{{data.title}}</h1>\n\n            </ion-list-header>\n\n            <!-- Content List -->\n\n            <ion-list>\n\n                <ion-item border no-lines *ngFor="let item of data.items" (tap)="onEvent(\'onButton\', item)">\n\n                    <!-- Content Title -->\n\n                    <ion-label item-title>{{item.title}}</ion-label>\n\n                    <ion-checkbox [checked]="item.isChecked"></ion-checkbox>\n\n                </ion-item>\n\n            </ion-list>\n\n        </ion-col>\n\n    </ion-row>\n\n</ion-grid>\n\n'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/components/check-box/layout-1/check-box.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], CheckBoxLayout1);
...
var ItemDetailsPageCheckBox = (function () {
    ...
    ItemDetailsPageCheckBox = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-check-box/item-details-check-box.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n        <ion-title text-left>{{params.title}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<!--Content-->\n\n<ion-content>\n\n    <!--CHECK BOX - LAYOUT 1 component-->\n\n    <check-box-layout-1 *ngIf="params.checkBoxesLayout1" [data]="params.data | async" [events]="params.events">\n\n    </check-box-layout-1>\n\n\n\n    <!--CHECK BOX - LAYOUT 2 component-->\n\n    <check-box-layout-2 *ngIf="params.checkBoxesLayout2" [data]="params.data | async" [events]="params.events">\n\n    </check-box-layout-2>\n\n\n\n    <!--CHECK BOX - LAYOUT 3 component-->\n\n    <check-box-layout-3 *ngIf="params.checkBoxesLayout3" [data]="params.data | async" [events]="params.events">\n\n    </check-box-layout-3>\n\n</ion-content>'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-check-box/item-details-check-box.html"*/
        }),
