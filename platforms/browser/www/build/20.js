...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_details_swipe_to_dismiss__ = __webpack_require__(894);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_list_view_swipe_to_dismiss_layout_1_swipe_to_dismiss_layout_1_module__ = __webpack_require__(576);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_list_view_swipe_to_dismiss_layout_2_swipe_to_dismiss_layout_2_module__ = __webpack_require__(577);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_list_view_swipe_to_dismiss_layout_3_swipe_to_dismiss_layout_3_module__ = __webpack_require__(578);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ItemDetailsPageSwipeToDismiss = (function () {
    ...
    ItemDetailsPageSwipeToDismiss = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-swipe-to-dismiss/item-details-swipe-to-dismiss.html"*/'<!--SwipeToDismiss component-->\n\n<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n        <ion-title text-left>{{params.title}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<!--Content-->\n\n<ion-content>\n\n    <swipe-to-dismiss-layout-1 *ngIf="params.swipeToDismissLayout1" [data]="params.data | async" [events]="params.events">\n\n    </swipe-to-dismiss-layout-1>\n\n\n\n    <swipe-to-dismiss-layout-2 *ngIf="params.swipeToDismissLayout2" [data]="params.data | async" [events]="params.events">\n\n    </swipe-to-dismiss-layout-2>\n\n\n\n    <swipe-to-dismiss-layout-3 *ngIf="params.swipeToDismissLayout3" [data]="params.data | async" [events]="params.events">\n\n    </swipe-to-dismiss-layout-3>\n\n</ion-content>'/*ion-inline-end:"/Users/ryanjbrant/Repos/ionicTemplate/src/pages/item-details-swipe-to-dismiss/item-details-swipe-to-dismiss.html"*/,
        }),
